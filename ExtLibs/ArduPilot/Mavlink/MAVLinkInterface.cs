...
namespace MissionPlanner
{
    public class MAVLinkInterface : MAVLink, IDisposable, IMAVLinkInterface, IMAVLinkInterfaceLogRead
    {
        ...
        public void Open(bool getparams, bool skipconnectedcheck = false, bool showui = true)
        {
            ...
            if (showui)
                frmProgressReporter = CreateIProgressReporterDialogue("ConnectingMavlink");
            else
            ...
            try
            {
                ...
                while (true)
                {
                    ...
                    if (DateTime.Now > deadline)
                    {
                        ...
                        if (hbseen)
                        {
                            PRsender.doWorkArgs.ErrorMessage = "Only1Hb";
...
Mission Planner waits for 2 valid heartbeat packets before connecting");
            ...
            catch (Exception e)
            {
                ...
                if (string.IsNullOrEmpty(PRsender.doWorkArgs.ErrorMessage))
                    PRsender.doWorkArgs.ErrorMessage = "ConnectFailed";
                log.Error(e);
                throw;
            }
        ...
        public void getParamList()
        {
            ...
            frmProgressReporter = CreateIProgressReporterDialogue("GettingParams" + " " + sysidcurrent);

            frmProgressReporter.DoWork += FrmProgressReporterGetParams;
            frmProgressReporter.UpdateProgressAndStatus(-1, "GettingParamsD");
